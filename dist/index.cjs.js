...
var SvgIcon = styled__default['default'].svg(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  fill: transparent;\n  flex-shrink: 0;\n  ", "\n  ", "\n"], ["\n  fill: transparent;\n  flex-shrink: 0;\n  ", "\n  ", "\n"])), function (_a) {
    var spin = _a.spin;
    return spin && spinStyle;
}, styledSystem.space);
Svg.defaultProps = {
...
var rotate$1 = styled.keyframes(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"], ["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"])));
...
function Loader(_a) {
    ...
    return (React__default['default'].createElement(StyledSVG, __assign({ viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", size: size, stroke: stroke }, rest),
...
var StyledButton = styled__default['default'].button(templateObject_1$3 || (templateObject_1$3 = __makeTemplateObject(["\n  align-items: center;\n  /* border: 0;\n  border-radius: 0.5rem;\n  box-shadow: 0px -1px 0px 0px rgba(14, 14, 44, 0.4) inset; */\n  box-shadow: 2px 1000px 1px #212230 inset;\n  cursor: pointer;\n  display: inline-flex;\n  font-family: inherit;\n  font-size: 16px;\n  font-weight: 600;\n  justify-content: center;\n  letter-spacing: 0.03em;\n  line-height: 1;\n  opacity: ", ";\n  outline: 0;\n  transition: background-color 0.2s;\n\n  border-radius: 0.5rem;\n  //color: ", ";\n\n  border: solid 3px transparent;\n  background-image: linear-gradient(rgba(255, 255, 255, 0), rgba(255, 255, 255, 0)), linear-gradient(90deg, #42d784, #60d5dc);\n  background-origin: border-box;\n  background-clip: content-box, border-box;\n  background: ", ";\n  \n  ", "\n\n  &:hover:not(:disabled):not(.pancake-button--disabled):not(.pancake-button--disabled):not(:active) {\n    opacity: 0.65;\n  }\n\n  &:active:not(:disabled):not(.pancake-button--disabled):not(.pancake-button--disabled) {\n    opacity: 0.85;\n  }\n\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n"], ["\n  align-items: center;\n  /* border: 0;\n  border-radius: 0.5rem;\n  box-shadow: 0px -1px 0px 0px rgba(14, 14, 44, 0.4) inset; */\n  box-shadow: 2px 1000px 1px #212230 inset;\n  cursor: pointer;\n  display: inline-flex;\n  font-family: inherit;\n  font-size: 16px;\n  font-weight: 600;\n  justify-content: center;\n  letter-spacing: 0.03em;\n  line-height: 1;\n  opacity: ", ";\n  outline: 0;\n  transition: background-color 0.2s;\n\n  border-radius: 0.5rem;\n  //color: ", ";\n\n  border: solid 3px transparent;\n  background-image: linear-gradient(rgba(255, 255, 255, 0), rgba(255, 255, 255, 0)), linear-gradient(90deg, #42d784, #60d5dc);\n  background-origin: border-box;\n  background-clip: content-box, border-box;\n  background: ", ";\n  \n  ",
    ...
    return variant === variants.TERTIARY || variant === variants.TEXT ? theme.colors[variant] : '';
}, function (props) {
...
var Icon$c = function (props) {
    return React__default['default'].createElement("img", __assign({}, props, { src: "/images/coins/BNB.png" }));
};
...
var Icon$y = function (props) {
    return React__default['default'].createElement("img", __assign({}, props, { src: "/images/coins/ENVI.png" }));
};
    ...
    return (React__default['default'].createElement(StyledAlert, null,
        ...
        onClick && (React__default['default'].createElement(CloseHandler, null,
            React__default['default'].createElement(IconButton, { scale: "sm", variant: "text", onClick: onClick },
                React__default['default'].createElement(Icon$l, { width: "24px", fill: "white" }))))));
};
...
var LinkExternal = function (_a) {
    ...
    return (React__default['default'].createElement(Link, __assign({ external: true }, props),
        children,
        React__default['default'].createElement(Icon$w, { color: "#6DD784", ml: "4px" })));
};
...
var float = styled.keyframes(templateObject_1$u || (templateObject_1$u = __makeTemplateObject(["\n\t0% {\n\t\ttransform: translatey(0px);\n\t}\n\t50% {\n\t\ttransform: translatey(10px);\n\t}\n\t100% {\n\t\ttransform: translatey(0px);\n\t}\n"], ["\n\t0% {\n\t\ttransform: translatey(0px);\n\t}\n\t50% {\n\t\ttransform: translatey(10px);\n\t}\n\t100% {\n\t\ttransform: translatey(0px);\n\t}\n"])));
...
var FloatingPanIcon = styled__default['default'](Icon$M)(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  position: absolute;\n  top: 40px;\n"], ["\n  position: absolute;\n  top: 40px;\n"])));
...
var Icon$T = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 50 50" }, props),
        React__default['default'].createElement("image", { width: "50", height: "50", x: "0", y: "0", xlinkHref: "data:image/png;base64," })));
};
...
var Icon$W = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ x: "0px", y: "0px", width: "24px", height: "24px", viewBox: "0 0 24 24", xmlSpace: "preserve" }, props),
        React__default['default'].createElement("path", { d: "M19 0H5a5 5 0 00-5 5v14a5 5 0 005 5h14a5 5 0 005-5V5a5 5 0 00-5-5zm-3 7h-1.924C13.461 7 13 7.252 13 7.889V9h3l-.238 3H13v8h-3v-8H8V9h2V7.077C10 5.055 11.064 4 13.461 4H16v3z" })));
};
...
var Icon$X = function (props) {
    ...
    // </SvgIcon>
    React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 28 28" }, props),
...
styled__default['default'].text(templateObject_1$y || (templateObject_1$y = __makeTemplateObject(["\n  font-size: 26.26px;\n  font-family: GoodTimingRg-Bold, Good Timing !important;\n  font-weight: 700;\n"], ["\n  font-size: 26.26px;\n  font-family: GoodTimingRg-Bold, Good Timing !important;\n  font-weight: 700;\n"])));
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(IconContainer, { isMobile: isMobile, isPushed: true },
...
var Icon$15 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 60 60" }, props),
        React__default['default'].createElement("g", { fill: "none" },
            React__default['default'].createElement("path", { style: {
                    transition: "fill .3s ease-in-out",
                }, d: "M13.488.025C6.015.131.01 6.213 0 13.686v32.628a13.68 13.68 0 0 0 23.357 9.675l9.287-9.289c.221 7.47 6.396 13.38 13.868 13.275C53.985 59.869 59.99 53.787 60 46.314V13.686a13.68 13.68 0 0 0-23.357-9.675L27.356 13.3C27.135 5.83 20.96-.08 13.488.025z", fill: "#6DD784" }),
            React__default['default'].createElement("circle", { style: {
                    transition: "cx .3s ease-in-out,cy .3s ease-in-out",
                }, fill: "#FFF", cx: 30, cy: 30, r: 13.686 }))));
};
...
var Icon$1h = function (props) {
    return (React__default['default'].createElement(SvgIcon, __assign({ width: "24px", height: "24px", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        React__default['default'].createElement("path", { d: "M2 20.6183C3.28475 20.1093 4.71525 20.1093 6 20.6183V20.6183C7.28476 21.1273 8.71524 21.1273 10 20.6183V20.6183C11.2848 20.1093 12.7152 20.1093 14 20.6183V20.6183C15.2848 21.1273 16.7152 21.1273 18 20.6183V20.6183C19.2848 20.1093 20.7152 20.1093 22 20.6183V20.6183", stroke: "#35B9C0", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        React__default['default'].createElement("path", { d: "M18 4C18 7.866 15.3137 11 12 11C8.68629 11 6 7.866 6 4", stroke: "#7BD784", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        React__default['default'].createElement("path", { d: "M3 18V3.5C3 3.36739 3.05268 3.24021 3.14645 3.14645C3.24021 3.05268 3.36739 3 3.5 3H5.5C5.63261 3 5.75979 3.05268 5.85355 3.14645C5.94732 3.24021 6 3.36739 6 3.5V18", stroke: "#7BD784", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        React__default['default'].createElement("path", { d: "M18 18V3.5C18 3.36739 18.0527 3.24021 18.1464 3.14645C18.2402 3.05268 18.3674 3 18.5 3H20.5C20.6326 3 20.7598 3.05268 20.8536 3.14645C20.9473 3.24021 21 3.36739 21 3.5V18", stroke: "#7BD784", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        React__default['default'].createElement("path", { d: "M18 15H6", stroke: "#7BD784", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        React__default['default'].createElement("path", { d: "M9 15V10.061", stroke: "#7BD784", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        React__default['default'].createElement("path", { d: "M12 15V11", stroke: "#7BD784", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        React__default['default'].createElement("path", { d: "M21 15H23", stroke: "#7BD784", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        React__default['default'].createElement("path", { d: "M3 15H1", stroke: "#7BD784", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        React__default['default'].createElement("path", { d: "M15 15V10.061", stroke: "#7BD784", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        React__default['default'].createElement("path", { d: "M23.0001 9C21.7002 7.66227 20.9814 5.86519 21.0001 4", stroke: "#7BD784", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        React__default['default'].createElement("path", { d: "M1 9C2.29991 7.66227 3.01874 5.86519 3 4", stroke: "#7BD784", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" })));
};

var Icon$1i = function (props) {
    return (React__default['default'].createElement(SvgIcon, __assign({ width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        React__default['default'].createElement("path", { d: "M16 17.3721V22.0001L18 21.0001L20 22.0001V17.3721", stroke: "#7BD784", "stroke-width": "1.5", "stroke-miterlimit": "10", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        React__default['default'].createElement("path", { d: "M18 18C19.933 18 21.5 16.433 21.5 14.5C21.5 12.567 19.933 11 18 11C16.067 11 14.5 12.567 14.5 14.5C14.5 16.433 16.067 18 18 18Z", stroke: "#7BD784", "stroke-width": "1.5", "stroke-miterlimit": "10", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        React__default['default'].createElement("path", { d: "M13 21H5C3.895 21 3 20.105 3 19V5C3 3.895 3.895 3 5 3H18C19.105 3 20 3.895 20 5V8", stroke: "#35B9C0", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        React__default['default'].createElement("path", { d: "M7 7H16", stroke: "#35B9C0", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        React__default['default'].createElement("path", { d: "M7 11H11", stroke: "#35B9C0", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        React__default['default'].createElement("path", { d: "M7 15H10", stroke: "#35B9C0", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" })));
};
...
var Icon$1r = function (props) {
    return (React__default['default'].createElement(SvgIcon, __assign({ style: { marginRight: "8px" }, width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        React__default['default'].createElement("path", { d: "M13 17.0001H15.333C15.766 17.0001 16.187 16.8601 16.533 16.6001L18.949 14.7881C19.552 14.3361 20.396 14.3961 20.929 14.9291C21.521 15.5211 21.521 16.4801 20.929 17.0711L18.856 19.1441C18.298 19.7021 17.586 20.0831 16.812 20.2381L13.882 20.8241C13.301 20.9401 12.702 20.9261 12.127 20.7821L9.477 20.1201C9.16 20.0401 8.835 20.0001 8.508 20.0001H7", stroke: "#35B9C0", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        React__default['default'].createElement("path", { d: "M13 17H14.485C15.322 17 16 16.322 16 15.485V15.182C16 14.487 15.527 13.881 14.853 13.713L12.561 13.14C12.188 13.047 11.806 13 11.422 13C10.495 13 9.588 13.274 8.817 13.789L7 15", stroke: "#35B9C0", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        React__default['default'].createElement("path", { d: "M6 21H4C3.448 21 3 20.552 3 20V14C3 13.448 3.448 13 4 13H6C6.552 13 7 13.448 7 14V20C7 20.552 6.552 21 6 21Z", stroke: "#7BD784", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        React__default['default'].createElement("path", { d: "M17.1687 5.15521C18.2771 6.26352 18.2771 8.06044 17.1687 9.16875C16.0604 10.2771 14.2635 10.2771 13.1552 9.16875C12.0469 8.06044 12.0469 6.26352 13.1552 5.15521C14.2635 4.0469 16.0604 4.0469 17.1687 5.15521Z", stroke: "#35B9C0", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        React__default['default'].createElement("path", { d: "M14.631 4.375C14.538 3.81 14.28 3.267 13.844 2.831C12.736 1.723 10.939 1.723 9.831 2.831C8.723 3.939 8.723 5.736 9.831 6.844C10.521 7.534 11.477 7.793 12.368 7.624", stroke: "#35B9C0", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" })));
};
...
var IconModule = /*#__PURE__*/Object.freeze({
    ...
    IfoIcon: Icon$Y,
    InfoIcon: Icon$Z,
    InstagramIcon: Icon$_,
    PlusIcon: Icon$$,
    LanguageIcon: Icon$10,
    LedgerIcon: Icon$11,
    LiquidityIcon: Icon$12,
    LogoIcon: Logo,
    MoonIcon: Icon$13,
    MoreIcon: Icon$14,
    NomicsIcon: Icon$15,
    ...
    VaultIcon: Icon$1i,
    StoreIcon: Icon$1j,
    AnalyticIcon: Icon$1k,
    DonateIcon: Icon$1l,
    BadgeNewIcon: Icon$1m,
    GaugeIcon: Icon$1n,
    inSpiritIcon: Icon$1o,
    NftZoo: Icon$1p,
    Rocket: Icon$1q,
    LendIcon: Icon$1r,
    MediumIcon: Icon$1s,
...
var SocialIcons = styled__default['default'].div(templateObject_1$z || (templateObject_1$z = __makeTemplateObject(["\n  display: flex;\n  justify-content: space-between;\n  width: 18rem;\n  margin: 0px 0.25em;\n\n  @media only screen and (max-width: 1000px) {\n    width: 100%;\n    margin-bottom: 30px;\n    justify-content: space-around;\n  }\n"], ["\n  display: flex;\n  justify-content: space-between;\n  width: 18rem;\n  margin: 0px 0.25em;\n\n  @media only screen and (max-width: 1000px) {\n    width: 100%;\n    margin-bottom: 30px;\n    justify-content: space-around;\n  }\n"])));
var SocialLinks = function () { return (React__default['default'].createElement(SocialIcons, null, socials.map(function (social) {
...
var StyledMenuButton = styled__default['default'](MenuButton)(templateObject_2$e || (templateObject_2$e = __makeTemplateObject(["\n  position: absolute;\n  left: ", ";\n  top: ", ";\n  padding: ", ";\n  width: 31px;\n  border-right: 1px solid rgb(55, 65, 81);\n  border-top: 1px solid rgb(55, 65, 81);\n  border-bottom: 1px solid rgb(55, 65, 81);\n  border: ", ";\n  border-bottom-left-radius: 0;\n  border-top-left-radius: 0;\n  background: transparent;\n"], ["\n  position: absolute;\n  left: ",
    ";\n  top: ",
    ";\n  padding: ",
    ";\n  width: 31px;\n  border-right: 1px solid rgb(55, 65, 81);\n  border-top: 1px solid rgb(55, 65, 81);\n  border-bottom: 1px solid rgb(55, 65, 81);\n  border: ", ";\n  border-bottom-left-radius: 0;\n  border-top-left-radius: 0;\n  background: transparent;\n"])), function (_a) {
...
var Logo$1 = function (_a) {
    ...
    return !isMobile ? (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(StyledMenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px", isMobile: isMobile, isPushed: isPushed }, isPushed ? React__default['default'].createElement(Icon$U, { width: "24px", color: "textSubtle" }) : React__default['default'].createElement(Icon$V, { width: "24px", color: "textSubtle" })),
        isAbsoluteUrl ? (React__default['default'].createElement(StyledLink$2, { as: "a", href: href, "aria-label": "Envi home page" }, innerLogo)) : (React__default['default'].createElement(StyledLink$2, { to: href, "aria-label": "Envi home page" }, innerLogo)))) : (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(StyledMenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px", isMobile: isMobile, isPushed: isPushed }, isPushed ? (React__default['default'].createElement(Icon$S, { width: "24px", color: "textSubtle" })) : (React__default['default'].createElement(Icon$R, { width: "24px", color: "textSubtle" }))),
        isAbsoluteUrl ? (React__default['default'].createElement(StyledLink$2, { as: "a", href: href, "aria-label": "Envi home page" }, innerLogo)) : (React__default['default'].createElement(StyledLink$2, { to: href, "aria-label": "Envi home page" }, innerLogo))));
};
...
var socials$1 = [
    ...
    },
    {
        label: "Medium",
        icon: "MediumIcon",
        href: "https://envicoin.medium.com/",
    },
];
var infos = [
    {
...
var MenuBottomEntry = styled__default['default'].div(templateObject_3$9 || (templateObject_3$9 = __makeTemplateObject(["\n  cursor: pointer;\n  display: flex;\n  align-items: flex-start;\n  height: ", "px;\n  text-decoration: underline;\n  padding: ", ";\n  margin: auto;\n  font-size: 15px; // ", ";\n  font-weight: bold;\n  background-color: transparent; // ", ";\n  color: lightgrey; // ", ";\n  box-shadow: ", ";\n  cursor: pointer;\n  align-self: flex-start;\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 400% 100%;\n  }\n"], ["\n  cursor: pointer;\n  display: flex;\n  align-items: flex-start;\n  height: ", "px;\n  text-decoration: underline;\n  padding: ", ";\n  margin: auto;\n  font-size: 15px; // ", ";\n  font-weight: bold;\n  background-color: transparent; // ", ";\n  color: lightgrey; // ", ";\n  box-shadow: ", ";\n  cursor: pointer;\n  align-self: flex-start;\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n  }\n\n  &:hover {\n    background-color: ",
...
var rotate$2 = styled.keyframes(templateObject_3$a || (templateObject_3$a = __makeTemplateObject(["\n    0% { transform: translate(0,  0px); }\n    50%  { transform: translate(8px, 0); }\n    100%   { transform: translate(0, -0px); }  \n  }\n"], ["\n    0% { transform: translate(0,  0px); }\n    50%  { transform: translate(8px, 0); }\n    100%   { transform: translate(0, -0px); }  \n  }\n"])));
var NewIcon = styled__default['default'](Icon$1m)(templateObject_4$5 || (templateObject_4$5 = __makeTemplateObject(["\n  position: absolute;\n  left: 155px;\n  width: 40px;\n  margin-right: 45px;\n  animation: ", " 6s infinite;\n"], ["\n  position: absolute;\n  left: 155px;\n  width: 40px;\n  margin-right: 45px;\n  animation: ", " 6s infinite;\n"])), rotate$2);
var MenuWrapper = styled__default['default'].div(templateObject_5$2 || (templateObject_5$2 = __makeTemplateObject(["\n  position: relative;\n  display: flex;\n  align-items: center;\n"], ["\n  position: relative;\n  display: flex;\n  align-items: center;\n"])));
var BottomContainer = styled__default['default'].div(templateObject_6$1 || (templateObject_6$1 = __makeTemplateObject(["\n  position: relative;\n  margin-top: auto;\n  margin-bottom: 9px;\n  display: grid;\n  grid-template-columns: repeat(3, minmax(0, 1fr));\n"], ["\n  position: relative;\n  margin-top: auto;\n  margin-bottom: 9px;\n  display: grid;\n  grid-template-columns: repeat(3, minmax(0, 1fr));\n"])));
...
var PriceLink = styled__default['default'].span(templateObject_1$I || (templateObject_1$I = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n\n  svg {\n    transition: transform 0.3s;\n  }\n"], ["\n  display: flex;\n  align-items: center;\n\n  svg {\n    transition: transform 0.3s;\n  }\n"])));
var CakePrice = function (_a) {
    ...
    var renderIcon = function () {
        ...
        return React__default['default'].createElement("img", __assign({ src: logoUrl }, styles));
        // switch(token) {
        //   case Token.SPIRIT: 
    ...
    //   }
    // };
    return priceUsd ? (React__default['default'].createElement(PriceLink, null,
        renderIcon(),
        React__default['default'].createElement(Link, { href: link, style: { marginLeft: "5px", textDecoration: "none" }, target: "_blank", color: "textSubtle", fontSize: "14px" }, "$" + priceUsd.toFixed(2)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 }));
};
var CakePrice$1 = React__default['default'].memo(CakePrice);
var templateObject_1$I;

var Icons$2 = IconModule;
var SocialLinks$2 = function () { return (React__default['default'].createElement(Flex, { style: { width: "100%" }, justifyContent: "space-around" }, socials$1.map(function (social, index) {
    var Icon = Icons$2[social.icon];
    var iconProps = { width: "21px", color: "textSubtle", style: { cursor: "pointer" }, colorFill: "#6DD784" };
    var mr = index < socials$1.length - 1 ? "7px" : 0;
    return (React__default['default'].createElement(Link, { external: true, key: social.label, href: social.href, "aria-label": social.label, mr: mr },
        React__default['default'].createElement(Icon, __assign({}, iconProps))));
}))); };
var SocialLinks$3 = React__default['default'].memo(SocialLinks$2, function () { return true; });

var Icons$3 = IconModule;
var SocialLinks$4 = function () { return (React__default['default'].createElement(Flex, { style: { width: "100%" }, justifyContent: "space-around" }, infos.map(function (info, index) {
    var Icon = Icons$3[info.icon];
    var iconProps = { width: index === 2 ? "29px" : "21px", color: "textSubtle", style: { cursor: "pointer" }, colorFill: "#6DD784" };
    var mr = index < infos.length - 1 ? "7px" : 0;
    return (React__default['default'].createElement(Link, { external: true, key: info.label, href: info.href, "aria-label": info.label, mr: mr },
        React__default['default'].createElement(Icon, __assign({}, iconProps))));
}))); };
var InfoLinks = React__default['default'].memo(SocialLinks$4, function () { return true; });
...
var SocialEntry = styled__default['default'].div(templateObject_2$i || (templateObject_2$i = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  height: ", "px;\n  padding: 0 8px;\n  width: 100%;\n"], ["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  height: ", "px;\n  padding: 0 8px;\n  width: 100%;\n"])), MENU_ENTRY_HEIGHT);
var PriceGroup = styled__default['default'].div(templateObject_3$b || (templateObject_3$b = __makeTemplateObject(["\n  display: grid;\n  padding: 0 8px;\n  gap: 3px;\n  grid-template-columns: repeat(2, 1fr);\n"], ["\n  display: grid;\n  padding: 0 8px;\n  gap: 3px;\n  grid-template-columns: repeat(2, 1fr);\n"])));
var Price = styled__default['default'].div(templateObject_4$6 || (templateObject_4$6 = __makeTemplateObject(["\n  flex: 1;\n  height: 42px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  height: ", "px;\n  padding: 8px;\n  border-radius: 4px;\n  background-color: rgba(109, 215, 132, 0.15);\n  margin: 0 2px;\n  // border-bottom: 1px solid #42BE71;\n"], ["\n  flex: 1;\n  height: 42px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  height: ", "px;\n  padding: 8px;\n  border-radius: 4px;\n  background-color: rgba(109, 215, 132, 0.15);\n  margin: 0 2px;\n  // border-bottom: 1px solid #42BE71;\n"])), PRICE_ENTRY_HEIGHT);
styled__default['default'](Price)(templateObject_5$3 || (templateObject_5$3 = __makeTemplateObject(["\n  background-color: #002943;\n  a {\n    color: #1C9BCA;\n  }\n"], ["\n  background-color: #002943;\n  a {\n    color: #1C9BCA;\n  }\n"])));
    ...
    return (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement(Container$3, null,
            React__default['default'].createElement(SocialEntry, null,
                React__default['default'].createElement(InfoLinks, null))),
        React__default['default'].createElement(PriceGroup, null, tokens.map(function (token) { return (React__default['default'].createElement(Price, null,
            React__default['default'].createElement(CakePrice$1, __assign({}, token)))); })),
        React__default['default'].createElement(Container$3, null,
            React__default['default'].createElement(SocialEntry, null,
                React__default['default'].createElement(SocialLinks$3, null)))));
};
var templateObject_1$J, templateObject_2$i, templateObject_3$b, templateObject_4$6, templateObject_5$3;

var StyledPanel = styled__default['default'].div(templateObject_1$K || (templateObject_1$K = __makeTemplateObject(["\n  position: fixed;\n  padding-top: \"80px\";\n  top: 0;\n  left: 0;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  flex-shrink: 0;\n  background: ", ";\n  width: ", ";\n  height: 91%;\n  transition: padding-top 0.2s, width 0.2s;\n  border: ", ";\n  margin-top: 70px;\n  margin: 70px 8px 8px 8px;\n  border-radius: 8px;\n  padding: ", ";\n  /* \n  border-right: ", ";\n  border-right: ", "; \n  */\n  /* \n    border-right: ", ";\n  */\n  z-index: 11;\n  overflow: ", ";\n  transform: translate3d(0, 0, 0);\n\n  ", " {\n    border-width: 1px;\n    // border-image: linear-gradient(to top, #42d785, rgba(0, 0, 0, 0)) 0% 100%;\n    width: ", ";\n  }\n"], ["\n  position: fixed;\n  padding-top: \"80px\";\n  top: 0;\n  left: 0;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  flex-shrink: 0;\n  background: ",
    ";\n  width: ", ";\n  height: 91%;\n  transition: padding-top 0.2s, width 0.2s;\n  border: ", ";\n  margin-top: 70px;\n  margin: 70px 8px 8px 8px;\n  border-radius: 8px;\n  padding: ", ";\n  /* \n  border-right: ", ";\n  border-right: ", "; \n  */\n  /* \n    border-right: ",
    ";\n  */\n  z-index: 11;\n  overflow: ", ";\n  transform: translate3d(0, 0, 0);\n\n  ", " {\n    border-width: 1px;\n    // border-image: linear-gradient(to top, #42d785, rgba(0, 0, 0, 0)) 0% 100%;\n    width: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.isDark
...
(function (ConnectorNames) {
    ...
    ConnectorNames["Provided"] = "provided";
...
var Tooltip = styled__default['default'].div(templateObject_2$j || (templateObject_2$j = __makeTemplateObject(["\n  display: ", ";\n  position: absolute;\n  bottom: -22px;\n  right: 0;\n  left: 0;\n  text-align: center;\n  background-color: ", ";\n  color: ", ";\n  border-radius: 0.5rem;\n  opacity: 0.7;\n"], ["\n  display: ", ";\n  position: absolute;\n  bottom: -22px;\n  right: 0;\n  left: 0;\n  text-align: center;\n  background-color: ", ";\n  color: ", ";\n  border-radius: 0.5rem;\n  opacity: 0.7;\n"])), function (_a) {
...
var UserBlock = function (_a) {
    ...
    var OwnButtonConnected = styled__default['default'](Button)(templateObject_3$c || (templateObject_3$c = __makeTemplateObject(["\n    border-radius: 0.5rem;\n    color: ", ";\n    box-shadow: 0 0 6px 0 rgba(157, 96, 212, 0.5);\n    border: solid 3px transparent;\n    background-image: linear-gradient(rgba(255, 255, 255, 0), rgba(255, 255, 255, 0)),\n      linear-gradient(90deg, #42d784, #60d5dc);\n    background-origin: border-box;\n    background-clip: content-box, border-box;\n    box-shadow: ", ";\n  "], ["\n    border-radius: 0.5rem;\n    color: ", ";\n    box-shadow: 0 0 6px 0 rgba(157, 96, 212, 0.5);\n    border: solid 3px transparent;\n    background-image: linear-gradient(rgba(255, 255, 255, 0), rgba(255, 255, 255, 0)),\n      linear-gradient(90deg, #42d784, #60d5dc);\n    background-origin: border-box;\n    background-clip: content-box, border-box;\n    box-shadow: ", ";\n  "])), function (_a) {
        var theme = _a.theme;
    ...
    if (!account) {
        return (React__default['default'].createElement("div", null,
            React__default['default'].createElement(OwnButtonDisconnected, { scale: "sm", onClick: function () {
                    onPresentConnectModal();
                } }, "Connect")));
    }
    return (React__default['default'].createElement("div", null, account && showMenu ? (React__default['default'].createElement(OwnButtonConnected, { scale: "sm", onClick: function () {
            onPresentAccountModal();
        } }, accountEllipsis)) : (React__default['default'].createElement(React__default['default'].Fragment, null))));
};
...
var UserBlock$1 = React__default['default'].memo(UserBlock, propsAreEqual);
var templateObject_1$N, templateObject_2$k, templateObject_3$c;

var Wrapper$2 = styled__default['default'].div(templateObject_1$O || (templateObject_1$O = __makeTemplateObject(["\n  position: relative;\n  width: 100%;\n"], ["\n  position: relative;\n  width: 100%;\n"])));
...
var BodyWrapper = styled__default['default'].div(templateObject_3$d || (templateObject_3$d = __makeTemplateObject(["\n  position: relative;\n  display: flex;\n"], ["\n  position: relative;\n  display: flex;\n"])));
...
var Menu = function (_a) {
    ...
    return (React__default['default'].createElement(Wrapper$2, null,
        ...
        React__default['default'].createElement(BodyWrapper, null,
            React__default['default'].createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, tokens: tokens, pushNav: setIsPushed, links: links }),
            React__default['default'].createElement(Inner, { isPushed: isPushed, showMenu: showMenu },
                children,
                React__default['default'].createElement(Text, { mt: "32px", mb: "24px", textAlign: "center", fontWeight: "400", color: "textSubtle" }, "The Currency of Eco-Conscious Engineering Technologies")),
...
var alertTypeMap = (_a$2 = {},
    ...
    _a$2);
var StyledToast = styled__default['default'].div(templateObject_1$P || (templateObject_1$P = __makeTemplateObject(["\n  right: 16px;\n  position: fixed;\n  max-width: calc(100% - 32px);\n  transition: all 250ms ease-in;\n  width: 100%;\n  margin-right: 30px;\n\n  ", " {\n    max-width: 400px;\n  }\n"], ["\n  right: 16px;\n  position: fixed;\n  max-width: calc(100% - 32px);\n  transition: all 250ms ease-in;\n  width: 100%;\n  margin-right: 30px;\n\n  ", " {\n    max-width: 400px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
var Fader = styled__default['default'].div(templateObject_2$m || (templateObject_2$m = __makeTemplateObject(["\n  position: absolute;\n  bottom: 0px;\n  left: 0px;\n  width: 100%;\n  height: 3px;\n  background-color: ", ";\n"], ["\n  position: absolute;\n  bottom: 0px;\n  left: 0px;\n  width: 100%;\n  height: 3px;\n  background-color: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.success;
});
...
var StyledToastContainer = styled__default['default'].div(templateObject_1$Q || (templateObject_1$Q = __makeTemplateObject(["\n  .enter,\n  .appear {\n    opacity: 0.01;\n  }\n\n  .enter.enter-active,\n  .appear.appear-active {\n    opacity: 1;\n    transition: opacity 250ms ease-in;\n  }\n\n  .exit {\n    opacity: 1;\n  }\n\n  .exit.exit-active {\n    opacity: 0.01;\n    transition: opacity 250ms ease-out;\n  }\n"], ["\n  .enter,\n  .appear {\n    opacity: 0.01;\n  }\n\n  .enter.enter-active,\n  .appear.appear-active {\n    opacity: 1;\n    transition: opacity 250ms ease-in;\n  }\n\n  .exit {\n    opacity: 1;\n  }\n\n  .exit.exit-active {\n    opacity: 0.01;\n    transition: opacity 250ms ease-out;\n  }\n"])));
...
exports.Tag = Tag;
exports.Text = Text;
exports.ThunderBgIcon = Icon$L;
exports.ThunderIcon = Icon$K;
